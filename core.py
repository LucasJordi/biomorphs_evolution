...
def get_rules_label():
    ...
    # rules_df['Concatenated'] = rules_df['Nome'].astype(str) + ' ' + rules_df['Regra'].astype(str)
    rules_df['Concatenated'] = rules_df['Nome'].astype(str)
    concatenated_list = rules_df['Concatenated'].tolist()
    return concatenated_list
def get_rules():
    return pd.read_csv('life_rules.csv')
